  ...
  return (
    <div>
      ...
      <form onSubmit={savePlace}>
        {preInput('Tên Căn Hộ', 'Tiêu đề cho địa điểm của bạn. nên ngắn gọn và hấp dẫn như trong quảng cáo')}
        ...
        <div className="grid gap-2 grid-cols-2 md:grid-cols-4">
          ...
          <div>
            <h3 className="mt-2 -mb-1">Tổng Số Người</h3>
            <input type="number" value={maxGuests}
                   onChange={ev => setMaxGuests(ev.target.value)}/>
          </div>
          <div>
            <h3 className="mt-2 -mb-1">Giá tháng</h3>
